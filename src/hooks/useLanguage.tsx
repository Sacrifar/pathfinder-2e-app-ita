...
const translations: Record<Language, Record<string, string>> = {
    ...
    it: {
        ...
        'rituals.alreadyKnown': 'Già Conosciuto',
        'filter.all': 'Tutti',
        ...
        'magicalItems.addStavesWands': 'Aggiungi Bastoni o Bacchette al tuo equipaggiamento per gestire le loro proprietà magical.',
