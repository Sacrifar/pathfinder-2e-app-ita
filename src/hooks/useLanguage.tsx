...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'spell.cost': 'Cost',
        'spell.signatureSpell': 'Signature Spell',
        'spell.heightenedVersions': 'Heightened Versions',
        'spell.heightened': 'Heightened',
        'spell.addHeightened': 'Add Heightened Version',
        'spell.removeSignature': 'Remove as Signature Spell',
        'spell.makeSignature': 'Make Signature Spell',
        'spell.signatureLimitReached': 'Signature Spell Limit Reached',
        'spell.noFocusPointsAvailable': 'No Focus Points available',
        'spell.noSlotsAvailable': 'No spell slots available',
        'spell.noUsesAvailable': 'No uses available',
        'actions.removeHeightened': 'Remove Heightened Version',
        'actions.openDicebox': 'Open dice box',
        'actions.castFocusSpell': 'Cast focus spell',
        'actions.castCantrip': 'Cast cantrip',
        'actions.castSpell': 'Cast spell',
        'actions.removeSpell': 'Remove Spell',
        'actions.castInnateSpell': 'Cast innate spell',
        ...
        // Esoteric Polymath
        'esotericPolymath.title': 'Esoteric Polymath',
        'esotericPolymath.dailyPreparation': 'Daily Preparation',
        'esotericPolymath.description': 'During your daily preparations, choose any one spell from your book of occult spells.',
        'esotericPolymath.noSpells': 'No spells in your spellbook yet.',
        'esotericPolymath.current': 'Current',
        'esotericPolymath.clear': 'Clear Selection',
        'esotericPolymath.inRepertoire': 'Additional signature spell for the day',
        'esotericPolymath.notInRepertoire': 'Treat as if in repertoire until next daily preparations',
        'esotericPolymath.signature': 'Signature',
        'esotericPolymath.spellbook': 'Spellbook',
        'esotericPolymath.spellbookDescription': 'Your spellbook contains all the occult spells you have learned. You can add new spells.',
        'esotericPolymath.addSpell': 'Add Spell',
        'esotericPolymath.removeFromSpellbook': 'Remove from spellbook',
        'esotericPolymath.dailyDescription': 'During your daily preparations, choose any one spell from your book of occult spells.',
        'esotericPolymath.currentPrep': 'Current Preparation',
    ...
    it: {
        ...
        'weapons.propertyRunes': 'Rune di Proprietà',
        'weapons.enterRuneName': 'Inserisci nome runa...',
        'weapons.addPropertyRune': 'Aggiungi Runa di Proprietà',
        ...
        'armor.propertyRunes': 'Rune di Proprietà',
        'armor.addPropertyRune': 'Aggiungi Runa di Proprietà',
        'armor.advancedCustomization': 'Personalizzazione Avanzata',
        'armor.customName': 'Nome Personalizzato',
        'armor.bonusAC': 'Bonus CA',
        'armor.checkPenaltyOverride': 'Sovrascrivi Penalità Tiri',
        'armor.speedPenaltyOverride': 'Sovrascrivi Penalità Velocità',
        ...
        'shield.propertyRunes': 'Rune di Proprietà',
        'shield.addPropertyRune': 'Aggiungi Runa di Proprietà',
        ...
        // Defense
        'defense.resistances': 'Resistenze e Immunità',
        'defense.noResistances': 'Nessuna',
        'defense.addResistance': 'Aggiungi Resistenza',
        'defense.addImmunity': 'Aggiungi Immunità',
        'defense.type': 'Tipo',
        ...
        'spell.cost': 'Costo',
        'spell.signatureSpell': 'Incantesimo Distintivo',
        'spell.heightenedVersions': 'Versioni Intensificate',
        'spell.heightened': 'Intensificato',
        'spell.addHeightened': 'Aggiungi Versione Intensificata',
        'spell.removeSignature': 'Rimuovi da Incantesimi Distintivi',
        'spell.makeSignature': 'Rendi Incantesimo Distintivo',
        'spell.signatureLimitReached': 'Limite Incantesimi Distintivi Raggiunto',
        'spell.noFocusPointsAvailable': 'Nessun Punto Focalizzazione disponibile',
        'spell.noSlotsAvailable': 'Nessuno slot incantesimo disponibile',
        'spell.noUsesAvailable': 'Nessun utilizzo disponibile',
        'actions.removeHeightened': 'Rimuovi Versione Intensificata',
        'actions.openDicebox': 'Apri lancia dadi',
        'actions.castFocusSpell': 'Lancia incantesimo focalizzato',
        'actions.castCantrip': 'Lancia trucchetto',
        'actions.castSpell': 'Lancia incantesimo',
        'actions.removeSpell': 'Rimuovi Incantesimo',
        'actions.castInnateSpell': 'Lancia incantesimo innato',
        ...
        'biography.nationality': 'Nazionalità',
        'biography.birthplace': 'Luogo di nascita',
        'biography.appearance': 'Aspetto Fisico',
        'biography.personality': 'Personalità & Comportamento',
        ...
        'biography.personalityPlaceholder': 'Descrivi la personalità del tuo personaggio... Tratti, maniere, come interagisce con gli altri, ecc.',
        ...
        // Deity
        'deity.selectDeity': 'Seleziona Divinità',
        'deity.searchDeities': 'Cerca divinità...',
        ...
        // Esoteric Polymath
        'esotericPolymath.title': 'Polimatta Esoterico',
        'esotericPolymath.dailyPreparation': 'Preparazione Giornaliera',
        'esotericPolymath.description': 'Durante i tuoi preparativi giornalieri, scegli un incantesimo dal tuo libro di incantesimi occulti.',
        'esotericPolymath.noSpells': 'Nessun incantesimo nel tuo libro degli incantesimi.',
        'esotericPolymath.current': 'Attuale',
        'esotericPolymath.clear': 'Cancella Selezione',
        'esotericPolymath.inRepertoire': 'Incantesimo distintivo aggiuntivo per il giorno',
        'esotericPolymath.notInRepertoire': 'Considera come se fosse nel repertorio fino ai prossimi preparativi giornalieri',
        'esotericPolymath.signature': 'Incantesimo distintivo',
        'esotericPolymath.spellbook': 'Libro Incantesimi',
        'esotericPolymath.spellbookDescription': 'Il tuo libro degli incantesimi contiene tutti gli incantesimi occulti imparati. Puoi aggiungerne di nuovi.',
        'esotericPolymath.addSpell': 'Aggiungi',
        'esotericPolymath.removeFromSpellbook': 'Rimuovi dal libro',
        'esotericPolymath.dailyDescription': 'Durante i tuoi preparativi giornalieri, scegli un incantesimo dal tuo libro.',
        'esotericPolymath.currentPrep': 'Preparazione Attuale',
        'esotericPolymath.selectFromBook': 'Seleziona dal Libro',
